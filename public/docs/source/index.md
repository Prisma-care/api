...
```bash
curl -X GET "http://prisma-backend.dev/v1/patient/{patient}/album" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/album",
    "method": "GET",
    "headers": {
...
```bash
curl -X POST "http://prisma-backend.dev/v1/patient/{patient}/album" \
-H "Accept: application/json" \
    -d "title"="dignissimos" \
...
```bash
curl -X GET "http://prisma-backend.dev/v1/patient/{patient}/album/{album}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/album/{album}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X DELETE "http://prisma-backend.dev/v1/patient/{patient}/album/{album}" \
-H "Accept: application/json"
```
...
```bash
curl -X PATCH "http://prisma-backend.dev/v1/patient/{patient}/album/{album}" \
-H "Accept: application/json" \
    -d "title"="quia" \
...
```bash
curl -X LINK "http://prisma-backend.dev/v1/patient/{patientId}/connection" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patientId}/connection",
    "method": "LINK",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X UNLINK "http://prisma-backend.dev/v1/patient/{patientId}/connection" \
-H "Accept: application/json"
```
...
```bash
curl -X GET "http://prisma-backend.dev/v1/album" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X POST "http://prisma-backend.dev/v1/album" \
-H "Accept: application/json"
```
...
```bash
curl -X GET "http://prisma-backend.dev/v1/album/{album}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album/{album}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X DELETE "http://prisma-backend.dev/v1/album/{album}" \
-H "Accept: application/json"
```
...
```bash
curl -X PATCH "http://prisma-backend.dev/v1/album/{album}" \
-H "Accept: application/json"
```
...
```bash
curl -X GET "http://prisma-backend.dev/v1/album/{album}/heritage" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album/{album}/heritage",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X POST "http://prisma-backend.dev/v1/album/{album}/heritage" \
-H "Accept: application/json" \
    -d "description"="asperiores" \
...
```bash
curl -X GET "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X DELETE "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}" \
-H "Accept: application/json"
```
...
```bash
curl -X PATCH "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}" \
-H "Accept: application/json"
```
...
```bash
curl -X POST "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}/asset" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}/asset",
    "method": "POST",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X GET "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}/asset/{asset}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/album/{album}/heritage/{heritage}/asset/{asset}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X POST "http://prisma-backend.dev/v1/invite" \
-H "Accept: application/json" \
    -d "email"="graham.stacy@example.com" \
    -d "firstName"="et" \
    -d "lastName"="et" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/invite",
    "method": "POST",
    "data": {
        "email": "graham.stacy@example.com",
        "firstName": "et",
...
```bash
curl -X POST "http://prisma-backend.dev/v1/patient" \
-H "Accept: application/json" \
    -d "firstName"="inventore" \
    -d "lastName"="inventore" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient",
    "method": "POST",
    "data": {
        "firstName": "inventore",
        "lastName": "inventore"
...
```bash
curl -X GET "http://prisma-backend.dev/v1/patient/{patient}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X POST "http://prisma-backend.dev/v1/patient/{patient}/story" \
-H "Accept: application/json" \
    -d "description"="nisi" \
    -d "creatorId"="nisi" \
    -d "albumId"="nisi" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/story",
    "method": "POST",
    "data": {
        "description": "nisi",
        "creatorId": "nisi",
...
```bash
curl -X GET "http://prisma-backend.dev/v1/patient/{patient}/story/{story}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/story/{story}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X DELETE "http://prisma-backend.dev/v1/patient/{patient}/story/{story}" \
-H "Accept: application/json"
```
...
```bash
curl -X PATCH "http://prisma-backend.dev/v1/patient/{patient}/story/{story}" \
-H "Accept: application/json"
```
...
```bash
curl -X POST "http://prisma-backend.dev/v1/patient/{patient}/story/{story}/asset" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/story/{story}/asset",
    "method": "POST",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X GET "http://prisma-backend.dev/v1/patient/{patient}/story/{story}/asset/{asset}" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/patient/{patient}/story/{story}/asset/{asset}",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X GET "http://prisma-backend.dev/v1/user" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/user",
    "method": "GET",
    "headers": {
        "accept": "application/json"
    }
...
```bash
curl -X POST "http://prisma-backend.dev/v1/user" \
-H "Accept: application/json" \
    -d "email"="bbradtke@example.com" \
    -d "password"="autem" \
    -d "firstName"="autem" \
