...
```bash
curl -X POST "http://prisma-backend.dev/v1/user/signin" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/user/signin",
    "method": "POST",
    "data": {
...
```bash
curl -X POST "http://prisma-backend.dev/v1/user/signout" \
-H "Accept: application/json"
```
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://prisma-backend.dev/v1/user/signout",
    "method": "POST",
    "headers": {
        "accept": "application/json"
    }
